...
namespace CargaArchivosMaxwarehouse.Clases
{
    class ManejoBD
    {
        ...
        public void EliminaRegistroAmazonRefunded(SqlConnection Conexion)
        {
            string sqlAInsertaRegistroDW = "EliminaRegistrosAmazonRefunded";
            SqlCommand EliminaDW = new SqlCommand(sqlAInsertaRegistroDW, Conexion);
        ...
        public void InsertaBDDW(CargaArchivosMaxwarehouse.Clases.ProcesarArchivoDW clsArchivoDW, SqlConnection Conexion)
        {
        ...
        public void InsertaBDFEDEX(CargaArchivos.PedidoFedex clsPedido, SqlConnection Conexion)
        {
            ...
            if (clsPedido.ExpressorGroundTrackingID == "393777428640")
                clsPedido.ExpressorGroundTrackingID = clsPedido.ExpressorGroundTrackingID;
        ...
        public void InsertaBDUSPS(CargaArchivos.PedidoUSPS clsPedido, SqlConnection Conexion)
        {
        ...
        public void InsertaBDUPS(CargaArchivos.PedidoUPS clsPedido, SqlConnection Conexion)
        {
        ...
        public void InsertaBDAMAZON(CargaArchivos.PedidoAmazon clsPedido, SqlConnection Conexion, bool esRetorno =false)
        {
        ...
        public void InsertaBOX(PesosDimensiones.Box clsPedido, SqlConnection Conexion)
        {
        ...
        public void InsertaEJDDimensions(PesosDimensiones.EJDDimensions clsPedido, SqlConnection Conexion)
        {
        ...
        public void InsertaJensenDimensions(PesosDimensiones.JensenDimensions clsPedido, SqlConnection Conexion)
        {
        ...
        public void InsertaMI15(PesosDimensiones.MI15 clsPedido, SqlConnection Conexion)
        {
        ...
        public void InsertaBDEndicia(CargaArchivos.PedidoEndicia clsPedido, SqlConnection Conexion)
        {
        ...
        public void InsertaBDCancelados(CargaArchivos.Clases.Cancelados clsPedido, SqlConnection Conexion)
        {
        ...
        public void InsertaBDAMAZONTransation(CargaArchivos.PedidoAmazon clsPedido, SqlConnection Conexion, bool esRetorno = false)
        {
            ...
            if (esRetorno == true)
            {
                sqlAInsertaRegistroDW = "InsertaRegistroAMAZONTransationRefunded";
            }
            else
            {
                sqlAInsertaRegistroDW = "InsertaRegistroAMAZONTransation";
            }
