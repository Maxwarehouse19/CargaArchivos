...
namespace CargaArchivos
{
    ...
    private void ObtieneValorRegistroDetalleUPS(string[] valor,/*DataRow row, */ref PedidoUPS clsPedido)
        ...
        private void ObtieneValorRegistroDetalleAmazon(string[] valor, ref PedidoAmazon clsPedido)
        {
            ...
            clsPedido.datetime = valor[0];
            clsPedido.settlementid = valor[1];
            clsPedido.type = valor[2];
            clsPedido.orderid = valor[3];
            clsPedido.sku = valor[4];
            clsPedido.description = valor[5];
            clsPedido.quantity = valor[6];
            clsPedido.marketplace = valor[7];
            clsPedido.accounttype = valor[8];
        ...
        // obtiene el valor del registro de EJDDimensions
        // ----------------------------------------------
        private void ObtieneValorRegistroCancelados(DataRow row, ref CargaArchivos.Clases.Cancelados clsPedido)
        {
        ...
        {
            CargaArchivosMaxwarehouse.Clases.ManejoBD clsInsertaRegistro = new CargaArchivosMaxwarehouse.Clases.ManejoBD();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                CargaArchivosMaxwarehouse.Clases.ManipulaExcel clsExcel = new CargaArchivosMaxwarehouse.Clases.ManipulaExcel();
                CargaArchivosMaxwarehouse.Clases.ProcesarArchivoDW clsArchivoDW = new CargaArchivosMaxwarehouse.Clases.ProcesarArchivoDW();
                CargaArchivosMaxwarehouse.Clases.ManejoBD clsInsertaRegistro = new CargaArchivosMaxwarehouse.Clases.ManejoBD();
                ...
                string PowerShellPSCargaArchivosFEDEX = ConfigurationManager.AppSettings["PSCargaArchivosFEDEX"];
                string PowerShellPSCargaArchivosUPS = ConfigurationManager.AppSettings["PSCargaArchivosUPS"];
                string PowerShellPSCargaArchivosUSPS = ConfigurationManager.AppSettings["PSCargaArchivosUSPS"];
                string PowerShellPSCargaArchivosAMAZON = ConfigurationManager.AppSettings["PSCargaArchivosAMAZON"];
                ...
                // crea archivo de Output CargaArchivosFEDEX
                // ----------------------------------------------
                ...
                //proc1.Verb = "runas";
                proc4.Arguments = "/c " + "powershell -ExecutionPolicy Bypass -File \"" + PowerShellPSCargaArchivosFEDEX + "\"";
                ...
                {
                    // crea archivo de Output CargaArchivosUPS
                    // ----------------------------------------------
                    ...
                    //proc1.Verb = "runas";
                    proc5.Arguments = "/c " + "powershell -ExecutionPolicy Bypass -File \"" + PowerShellPSCargaArchivosUPS + "\"";
                ...
                if (FlgSihayUSPS == true)
                {
                    ...
                    //proc1.Verb = "runas";
                    proc6.Arguments = "/c " + "powershell -ExecutionPolicy Bypass -File \"" + PowerShellPSCargaArchivosUSPS + "\"";
                ...
                if (FlgSihayAmazon == true)
                {
                    ...
                    //proc1.Verb = "runas";
                    proc7.Arguments = "/c " + "powershell -ExecutionPolicy Bypass -File \"" + PowerShellPSCargaArchivosAMAZON + "\"";
        ...
        private void CargaCancelados(SqlConnection Conexion)
        {
            ...
            foreach (var Archivos in Directorios.GetFiles())
            {
                ...
                foreach (DataRow row in dataSet.Tables[0].Rows)
                {
                    CargaArchivos.Clases.Cancelados clsPedido = new CargaArchivos.Clases.Cancelados();
        ...
        private void EjecutaProceso()
        {
            try
            {
                ...
                //    cmd.CommandType = CommandType.StoredProcedure;
                //    cmd.CommandTimeout = 9200; //in seconds
                //    SqlDataReader reader = cmd.ExecuteReader();
                //
                //    //Create a new DataTable.
                //    System.Data.DataTable dt = new System.Data.DataTable("Resultado");
